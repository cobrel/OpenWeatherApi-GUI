...
public class ForecastDay2 extends OpenWeatherApi {

	// date
	public String data_forecastDay2() {
	...
	public String weatherConditionDay2() {

		String formattedIncrementedDate = data_forecastDay2();
	...
	// weather icon
	public String iconForecastDay2() {
		String formattedIncrementedDate = data_forecastDay2();
		int size = js_third.getInt("list.size()");
		String[] iconIdForecastDay2 = new String[size];
		...
		for (int i = 0; i < size; i++) {
			...
			String formattedDate = dateTime.format(DateTimeFormatter.ofPattern("EEEE dd MMMM"));
			if (formattedDate.equals(formattedIncrementedDate)) {
				iconIdForecastDay2[i] = icon;
			}
		}

		int maxCount = 0;
		String mostCommonIconId = null;
		for (String iconId : iconIdForecastDay2) {
		    if (iconId != null) {
		        ...
		        int count = 0;
		        for (String otherIconId : iconIdForecastDay2) {
		...
		} else if (weatherConditionDay2().equals("Rain")) {
		    return "10d";
		} else {
	...
	// highest temperature
	public String highest_tempDay2() {
	...
	// pricipitation
	public String precipitation_forecast_day2() {
	...
	public String lowest_wind_speedDay2() {
	...
	public String highest_wind_speedDay2() {
